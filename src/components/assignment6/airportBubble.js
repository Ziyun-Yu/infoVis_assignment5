...
import { groupByAirline, groupByCity } from "./utils";
    ...
    if(selectedAirline){
        ...
        return <g>
                {cities.map((d, idx) => {
                    ...
                    return <g key={idx} transform={`translate(${d.x}, ${d.y})`}>
                            <circle
                                key={idx}
                                r={raidus(d.Count)}
        ...
        // When selectedAirline is null, reuse the same logic but group all cities
